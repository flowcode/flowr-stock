...
namespace Flower\StockBundle\Tests\Controller;
...
class StockLevelControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $crawler = $client->request('GET', '/stock/stocklevel/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'stocklevel[name]' => 'Lorem ipsum dolor sit amet',
            'stocklevel[stock]' => 42,
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/stock/stocklevel/new');
